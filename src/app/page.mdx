...
import imgPhotoLisa from "public/images/photo_lisa.jpg";
import imgPhotoSimona from "public/images/photo_simona.png";
import imgPhotoYasaman from "public/images/photo_yasaman.jpg";
...
<Box display="flex" flexDirection="row" alignItems="flex-start">
  ...
  <Box marginTop={-2} marginBottom={-2} marginRight={2}>
    <p>Yasaman Sefidgar</p>
    <p>she/her</p>
    <p>
       {/* alt="", Treat as decorative, because name is read above */}
      <Image src={imgPhotoYasaman}
             basePath={Paths.basePath}
             height="150"
             alt=""
      />
...
- Office Hours
  ...
  - Jesse, Wednesdays 11:00 to 12:00, [CSE2](https://uw.edu/maps/?cse2) 151.
  - Simona, Thursdays 12:00 to 1:00, [CSE2](https://uw.edu/maps/?cse2) 150.
  </TBD>
...
- __65%__: Group Project
  ...
  - __25%__: <SiteLink linkKey={SiteLinks.assignmentsAssignment2Top} outerComponent="span" />: Getting the Right Design
  ...
  - __20%__: <SiteLink linkKey={SiteLinks.assignmentsAssignment3Top} outerComponent="span" />: Getting the Design Right
  ...
  - __15%__: <SiteLink linkKey={SiteLinks.assignmentsAssignment4Top} outerComponent="span" />: Communicating the Design
    - 4web: Web Post (8%)
