...
- __65%__: Group Project
  - __5%__: <SiteLink linkKey={SiteLinks.milestone1Top} outerComponent="span" />: Project Proposal
    - 1a: Individual Brainstorm (1%)
    - 1b: Group Proposals (2%)
    - 1c: Finalized Proposal (2%)
  - __25%__: <SiteLink linkKey={SiteLinks.milestone2Top} outerComponent="span" />: Getting the Right Design
  ...
  - __20%__: <SiteLink linkKey={SiteLinks.milestone3Top} outerComponent="span" />: Getting the Design Right
  ...
  - __15%__: <SiteLink linkKey={SiteLinks.milestone4Top} outerComponent="span" />: Communicating the Design
    - 4web: Web Post (8%)
