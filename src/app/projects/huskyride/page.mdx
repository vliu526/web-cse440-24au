...
Our design research aimed to gain insights into how commuter students 
...
Our initial understanding of an ideal carpooling situation was limited to 
...
which was handling riders who were running late or were consistently late.
...
Initially, the concept of carpooling seemed very similar to UberPool or 
...
One interviewee noted unpredictable schedule changes due to having to not only 
...
In the original design, drivers only had access to the Auto-Suspend feature 
...
In our initial app prototype, we wanted to give the drivers flexibility and boundaries 
...
an information pop-up that explains its functionality to clear up any confusion. 
...
Consistency was another key insight derived from the evaluations. In the original 
