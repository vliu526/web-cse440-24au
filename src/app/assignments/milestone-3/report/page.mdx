...
1. __Design Problem and Tasks__
   ...
   You may use text from an earlier assignment as a starting point,
   but you should revise such text to account for feedback and for clarity you have gained in your design exploration.
   ...
   These may be based in tasks you submitted in earlier assignments,
   might be revised better describe an earlier task,
   ...
   Such insights might be about the tasks themselves or about how those tasks shaped design exploration.
   For example:
   ...
   - Did design explorations suggest consideration of other tasks
     ...
     suggest other tasks and design directions you might have explored with more time)?
