...
Due: <AssignmentDueDateTime assignmentKey={calendarData.assignments.assignment0} />

One page in PDF format. Submit via Canvas here:

<AssignmentSubmitCanvasLink assignmentKey={calendarData.assignments.assignment0} />
