...
Ask participants to think aloud during usability tests.
...
- Present **3 revisions made in response to inspection-based evaluation**.
  ...
  - A description of the usability issue.
...
- Provide a description of your **usability testing method**.
  ...
  any details of usability testing you designed according to needs of learning about your prototype,
  how you presented testing tasks to participants,
  any relevant details of usability testing participants).

  If your method changed between sessions, detail what changes were made and why.
...
- Prepare a Slides deck with the following structure:
  ...
  Revisions based on inspection-based evaluation (3 revisions):
  ...
  Revisions based on usability testing (4 revisions):
    - 1 or 2 slides for each revision:
      - At least one image of the relevant portion of the prototype.
  ...
  Revision based on unintentional exclusion (1 revision):
    - 1 or 2 slides:
      - At least one image of the relevant portion of the prototype.
...
1. __Revisions from Inspection Methods (3 total)__

    Address at least 3 usability issues identified through heuristic evaluation in Assignment 4.2
    or through other inspection methods.


2. __Usability Testing Method__

    Describe your testing method and participants, with particular detail around how you structured
    the usability testing activity. If your method changed between sessions, describe that as well.

   
3. __Revisions from Usability Testing (4 total)__
    
    Revise your paper prototype based on what you learn in usability testing.
    Revisions may be small or large, depending on the identified usability issue.


4. __Revision from Unintentional Exclusion (1 total)__

    Present one revision made to address unintentional exclusion in your design.
    Describe the assumption you identified in your design, including how this assumption 
    would unintentionally exclude people from your design.    

5. __Final Paper Prototype – Overview__

    Present your final paper prototype, updated with revisions from this process.


6. __Final Paper Prototype - Task Walkthroughs (2 total)__

    For each focus task, present a step-by-step task walkthrough with the paper prototype.


7. __Clarity and Presentation__
