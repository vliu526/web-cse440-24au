...
6. __Focus Task Walkthroughs__: (XX points)
...
7. __Design Research Insights__: (XX points)
...
8. __Iterative Design Insights Insights__: (XX points)
...
9. __Clarity and Presentation__: (XX points)

10. __Submission via Pull Request__: (XX points)

    Submit your web post and revisions as pull requests.

    Be responsive to any challenges of integrating and publishing your post.

    We expect to merge and publish revisions throughout the week, with the post being complete at the stated deadline.
