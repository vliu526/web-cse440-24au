...
1. A preliminary draft sufficient for in-class discussion and critique. 
   This draft should either include an attempt at each of the final components of the web post,
   or specific notes and questions about any uncompleted components to support in-class discussion.

2. Successful integration of the post into the course website via pull request.
...
10. __Submission via Pull Request__: (XX points)
    ...
    Submit your initial web post and revisions to that post as pull requests.
